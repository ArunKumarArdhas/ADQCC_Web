...
function validataionOTP() {
    ...
    var e = $("#Username").val(),
        a = $("#Password").val(),
        r = $('input[name="Language"]:checked').val();
    ...
    return $.ajax({
        ...
        ContentType: "application/x-www-form-urlencoded;charset=UTF-8",
        success: function (e) {
            "200" == e.STATUS_CODE ? ($("#LoginDiv").hide(100), $("#OptDiv").show(100)) : ($("#Password").val(""), submit = 0, toastr.error("User Does not Exits", "Error")), $("#Loaderbck").hide(), $("#Loader").hide()
        }
    }), !0
}
