...
(function (factory) {
    ...
    var NAMESPACE, objUrl, compare, isIE, isEdge, handler, previewCache, getNum, hasFileAPISupport, hasDragDropSupport,
        ...
        tActions, tActionDelete, tActionUpload, tZoom, tGeneric, tHtml, tImage, tText, tVideo, tAudio, tFlash, tObject,tDocument,
    ...
    tObject = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}"' +
        ...
        '   {footer}\n' +
        '</div>';
    tDocument = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}"' +
        ' title="{caption}" ' + STYLE_SETTING + '>\n' +
        '   <object class="file-object" data="{data}" type="{type}" width="{width}" height="{height}">\n' +
        '       <param name="movie" value="{caption}" />\n' +
        OBJECT_PARAMS + '         ' + DEFAULT_PREVIEW + '\n' +
    ...
    defaultPreviewTypes = ['image', 'html', 'text', 'video', 'audio', 'flash', 'object','document'];
    defaultPreviewSettings = {
        ...
        document: { width: "160px", height: "160px" },
    ...
    defaultFileTypeSettings = {
        ...
        html: function (vType, vName) {
            return compare(vType, 'text/html') || compare(vName, /\.(htm|html|odt)$/i);
        },
        ...
        document: function (vType, vName) {
            return compare(vType, 'application/msword', true) || compare(vName, /\.(docx|doc|ppt|pptx|xls|pps|ppsx)$/i);
        },
